    ...
    <div className="w-full">
      <section className="w-full bg-background-dark">
        <div className="mx-auto w-full max-w-container space-y-10.5 px-5 pt-10.5 md:px-8 md:pt-14 lg:space-y-16 lg:px-5 lg:pt-28">
          <div className="space-y-5 lg:flex lg:items-end lg:justify-between">
            ...
            <div className="space-y-5 lg:max-w-[43.5rem] lg:space-y-8">
          ...
          <div className="h-[13.75rem] w-full bg-[#D9D9D9] md:h-[26.25rem] lg:h-[38.75rem]">
            <Image
      ...
      <section className="mx-auto w-full max-w-container space-y-8 px-5 pb-8 pt-16 md:px-8 lg:flex lg:space-y-0 lg:px-5 lg:pb-14 lg:pt-28">
        ...
        <div className="space-y-8 lg:max-w-[43.5rem] lg:space-y-12">
          <p className="hidden text-lg font-medium leading-relaxed text-text-dark-secondary md:text-xl lg:block lg:text-2xl">
            Participei ativamente na criação da interface de usuário da
            plataforma Dev Experience. Apliquei as melhores práticas de design
            para garantir uma jornada do usuário agradável, desde o acesso à
            plataforma até a conclusão dos projetos, visando tanto estética
          ...
          <div className="space-y-6 lg:space-y-8">
            <p className="text-lg font-medium leading-relaxed text-text-dark-secondary md:text-xl lg:text-2xl">
            ...
            <div className="flex items-center gap-5">
              <div className="size-11.5 bg-[#D9D9D9] lg:size-13">
                <Image
              ...
              <div className="flex flex-col gap-2">
                ...
                <span className="text-sm leading-none text-text-dark-secondary lg:text-base">
      ...
      <section className="mx-auto w-full max-w-container">
        <div className="border-b border-border-white-primary px-5 pb-10.5 pt-8 md:px-8 lg:pb-14 lg:pt-14">
          <div className="grid grid-cols-2 gap-3">
            <div className="col-span-2 h-[11.25rem] bg-[#D9D9D9] md:h-[23.75rem] lg:h-[30rem]" />
            <div className="h-[11.25rem] bg-[#D9D9D9] md:h-[13.75rem] lg:h-[30rem]" />
            <div className="h-[11.25rem] bg-[#D9D9D9] md:h-[13.75rem] lg:h-[30rem]" />
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto w-full max-w-container space-y-8 px-5 pb-16 pt-10.5 md:px-8 lg:px-5 lg:pb-28 lg:pt-14">
        ...
        <div className="grid-cols grid gap-3">
          <div className="col-span-2 h-[11.25rem] w-full bg-[#D9D9D9] md:h-[23.75rem] lg:h-[30rem]" />
          <div className="h-28 w-full bg-[#D9D9D9] md:h-[13.75rem] lg:h-[30rem]" />
          <div className="h-28 w-full bg-[#D9D9D9] md:h-[13.75rem] lg:h-[30rem]" />
          <div className="col-span-2 h-[22.5rem] w-full bg-[#D9D9D9] md:h-[23.75rem] lg:h-[60rem]" />
        </div>
      </section>
