...
export function FigmaHand(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      <g clip-path="url(#clip0_630_1841)">
        ...
        />
        <path
          d="M12 11.25V4.125C12 3.62772 12.1975 3.15081 12.5492 2.79917C12.9008 2.44754 13.3777 2.25 13.875 2.25C14.3723 2.25 14.8492 2.44754 15.2008 2.79917C15.5525 3.15081 15.75 3.62772 15.75 4.125V11.25"
          stroke="#040404"
          stroke-width="1.6"
          stroke-linecap="round"
          stroke-linejoin="round"
